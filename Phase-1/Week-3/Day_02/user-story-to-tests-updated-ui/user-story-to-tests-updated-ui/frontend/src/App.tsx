...
function App() {
  ...
  const selectedJiraStory = jiraStories.find((story) => story.key === selectedJiraStoryKey)
    ...
    <div>
      <style>{`
        * {
        ...
        .reset-btn {
          background: linear-gradient(145deg, #ff3b30 0%, #d90000 52%, #a90000 100%);
          ...
          min-width: 92px;
          box-shadow: inset 0 2px 2px rgba(255,255,255,0.38), inset 0 -5px 8px rgba(80,0,0,0.3), 0 7px 14px rgba(156,0,0,0.28);
          flex-shrink: 0;
          height: fit-content;
        }
        ...
        .reset-btn:hover:not(:disabled) {
          ...
          box-shadow: inset 0 2px 2px rgba(255,255,255,0.42), inset 0 -5px 8px rgba(80,0,0,0.3), 0 10px 18px rgba(156,0,0,0.34);
        ...
        .jira-story-label::before {
          content: '';
          width: 4px;
          height: 18px;
          border-radius: 999px;
          background: linear-gradient(180deg, var(--brand), var(--brand-dark));
          box-shadow: 0 2px 7px rgba(0,200,83,0.35);
        }
        ...
        .download-btn {
          background: linear-gradient(105deg, #00c9c8 0%, #08bfa5 42%, #ffad2f 100%);
          color: #fff;
          ...
          cursor: pointer;
          transition: transform 0.15s ease, box-shadow 0.25s ease, filter 0.2s;
          box-shadow: inset 0 2px 2px rgba(255,255,255,0.4), inset 0 -4px 8px rgba(0,79,95,0.22), 0 8px 18px rgba(0,150,153,0.3);
          display: inline-flex;
          align-items: center;
          justify-content: center;
          gap: 8px;
        ...
        .download-icon {
          ...
          justify-content: center;
          border-radius: 50%;
          background: rgba(0, 205, 202, 0.82);
          box-shadow: inset 0 2px 4px rgba(255,255,255,0.28), 0 2px 5px rgba(0,94,110,0.22);
          font-size: 26px;
          font-weight: 400;
          line-height: 1;
          letter-spacing: 0;
        ...
        .download-btn:hover:not(:disabled) {
          transform: translateY(-2px);
          box-shadow: inset 0 2px 2px rgba(255,255,255,0.45), inset 0 -4px 8px rgba(0,79,95,0.22), 0 12px 24px rgba(0,150,153,0.4);
          filter: brightness(1.03);
        }
            ...
            <div className="jira-panel">
              ...
              {jiraConnected && jiraStories.length > 0 && (
                <div className="jira-stories">
                  <label htmlFor="jiraStory" className="jira-story-label">Select a Jira User Story</label>
                  <select
                    id="jiraStory"
                    className="jira-story-select"
                    value={selectedJiraStoryKey || ''}
                    onChange={(e) => {
                      const story = jiraStories.find((item) => item.key === e.target.value)
                      if (story) handleAddJiraStoryToForm(story)
                    }}
                  >
                  ...
                  {selectedJiraStory && (
                    <a
                      className="jira-open-story-btn"
                      href={selectedJiraStory.url}
                      target="_blank"
                      rel="noreferrer"
                    >
                      Open {selectedJiraStory.key} in Jira ↗
                    </a>
                  )}
                  <a
                    className="jira-open-story-btn jira-open-all-btn"
                    href={`${jiraConfig.baseUrl.trim().replace(/\/+$/, '')}/issues/?jql=${encodeURIComponent('issuetype = Story ORDER BY created DESC')}`}
                    target="_blank"
                    rel="noreferrer"
                  >
                    Open all stories in Jira ↗
                  </a>
                </div>
              )}
